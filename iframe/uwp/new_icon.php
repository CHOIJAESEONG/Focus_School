...
<div class = "icon_container">
	...
	<h5 class="sub_title">Animated Spinner icons (with subclass mif-ani-spin)</h5>
	<ul class="inline-list icon-list">
	...
	<h5 class="sub_title">Animated Spinner icons (with subclass mif-ani-pulse)</h5>
	<ul class="inline-list icon-list">
	...
	<h5 class="sub_title">Normal speed</h5>
	<ul class="inline-list icon-list">
	...
	<h5 class="sub_title">Fast speed (with subclass mif-ani-fast)</h5>
	<ul class="inline-list icon-list">
	...
	<h5 class="sub_title">Slow speed (with subclass mif-ani-slow)</h5>
	<ul class="inline-list icon-list">
