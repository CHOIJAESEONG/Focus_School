...
view와 함께 함하고 orginize하는 하나의 더 좋은 방법입니다. cards에는 사진, 텍스트 및 링크와 같은 고유 한 관련 데이터가 모두 포함되어 있습니다. Cards는 일반적으로보다 복잡하고 상세한 정보에 대한 진입 점입니다.</li>	
				</ul>
				<iframe src="<?=IFRPATH?>frm7/cards.php?is_ifr=1" style="border-cards:none;width:100%;max-width:980px;height:500px;"></iframe>		
				<div class="try_btn_wrapper" style="">
					<button type="button" class="btn btn-success" ><a href="<?=IFRPATH?>frm7/cards.php" target="_blank" style="color:white;">Demo</a></button>
				</div>
			</div>
        </div>
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2" style="padding:0px;height:80px;">
			<div class="page_prev_w" style="position:absolute;bottom:0px;left:0px;width:50%;height:80px;background:#fff;">
				<a href="<?=WIGPATH?>frm7/accordian.php" class="page_prev" id="btn_prev" aria-label="이전페이지">
			...
			<div class="page_next_w" style="position:absolute;bottom:0px;right:0px;width:50%;height:80px;background:#fff;text-align:right;">
				<a class="page_next" href="<?=WIGPATH?>frm7/button.php" id="btn_next" aria-label="다음페이지">
