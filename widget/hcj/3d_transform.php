      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="padding-top:15px;text-align:center;height:980px;">
			...
			<div class="row placeholders" >
				<h1 class="page-header" style="margin:15px;text-align:left;">3D Transforms</h1>
				<ul style="text-align:left;font-size:18px;">
					<li style="margin:15px 0;padding-right:15px;">rotate3d</li>
					<li style="margin:15px 0;padding-right:15px;">translate3d</li>
					<li style="margin:15px 0;padding-right:15px;">scale3d</li>
					<li style="margin:15px 0;padding-right:15px;">matrix3d</li>
				</ul>
			</div>
			
			<div class="row placeholders" style="padding:0px;">
				<iframe src="<?=IFRPATH?>hcj/3d_transform.php?is_ifr=1" style="border:none;width:100%;max-width:980px;height:300px;"></iframe>		
				<div class="try_btn_wrapper" style="">
					<button type="button" class="btn btn-success" ><a href="<?=IFRPATH?>hcj/3d_transform.php" target="_blank" style="color:white;">Demo</a></button>
				</div>
			</div>
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2" style="padding:0px;height:80px;">
			<div class="page_prev_w" style="position:absolute;bottom:0px;left:0px;width:50%;height:80px;background:#4E342E;">
				<a href="<?=WIGPATH?>hcj/index.php" class="page_prev" id="btn_prev" aria-label="이전페이지">
					<span class="svg_prev">
			...
			<div class="page_next_w" style="position:absolute;bottom:0px;right:0px;width:50%;height:80px;background:#EF6C00;text-align:right;">
				<a class="page_next" href="<?=WIGPATH?>hcj/anim.php" id="btn_next" aria-label="다음페이지">
					<span class="svg_next">
						<svg xmlns="#" viewBox="0 0 24 24">
