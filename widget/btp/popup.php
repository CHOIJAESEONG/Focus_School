      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="padding-top:15px;text-align:center;height:800px;">
			...
			<div class="row placeholders" style="padding:0px;">
				<h1 class="page-header" style="margin:15px;text-align:left;">Modal/Popup</h1>
				<iframe src="<?=IFRPATH?>btp/popup.php?is_ifr=1" style="border:none;width:100%;max-width:980px;height:300px;"></iframe>		
				<div class="try_btn_wrapper" style="">
					<button type="button" class="btn btn-success" ><a href="<?=IFRPATH?>btp/popup.php" target="_blank" style="color:white;">Demo</a></button>
				</div>
			</div>
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2" style="padding:0px;height:80px;">
			<div class="page_prev_w" style="position:absolute;bottom:0px;left:0px;width:50%;height:80px;background:#8e24aa;">
				<a href="<?=WIGPATH?>btp/collapse.php" class="page_prev" id="btn_prev" aria-label="이전페이지">
					<span class="svg_prev">
